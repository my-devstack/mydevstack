module github.com/my-devstack/mydevstack
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudformation v1.76.5
	...
	github.com/aws/aws-sdk-go-v2/service/opensearch v1.75.8
