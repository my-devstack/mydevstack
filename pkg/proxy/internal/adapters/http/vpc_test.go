...
func performVpcRequest(handler *ProxyHandler, method, path string, body []byte) *httptest.ResponseRecorder {
	r := chi.NewRouter()
	handler.registerVpcRoutes(r)
...
func TestVpc_ListVpcs_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "GET", "/vpc/vpcs", []byte(`{}`))
...
func TestVpc_CreateVpc_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/vpcs", []byte(`{"CidrBlock":"10.0.0.0/16"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateVpc_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/vpcs", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DeleteVpc_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/vpcs/vpc-123", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_ListSubnets_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "GET", "/vpc/subnets", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateSubnet_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/subnets", []byte(`{"VpcId":"vpc-123","CidrBlock":"10.0.1.0/24"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateSubnet_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/subnets", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DeleteSubnet_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/subnets/subnet-123", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_ListRouteTables_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "GET", "/vpc/route-tables", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateRouteTable_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/route-tables", []byte(`{"VpcId":"vpc-123"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateRouteTable_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/route-tables", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DeleteRouteTable_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/route-tables/rtb-123", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateRoute_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/route-tables/rtb-123/routes", []byte(`{"DestinationCidrBlock":"0.0.0.0/0","GatewayId":"igw-123"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateRoute_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/route-tables/rtb-123/routes", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DeleteRoute_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/route-tables/rtb-123/routes/0.0.0.0%2F0", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_AssociateRouteTable_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/route-tables/rtb-123/associate", []byte(`{"SubnetId":"subnet-123"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_AssociateRouteTable_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/route-tables/rtb-123/associate", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DisassociateRouteTable_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/route-tables/rtb-123/disassociate", []byte(`{"AssociationId":"rtbassoc-123"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_DisassociateRouteTable_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/route-tables/rtb-123/disassociate", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_ListInternetGateways_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "GET", "/vpc/internet-gateways", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateInternetGateway_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/internet-gateways", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_DeleteInternetGateway_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/internet-gateways/igw-123", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_AttachInternetGateway_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/internet-gateways/igw-123/attach", []byte(`{"VpcId":"vpc-123"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_AttachInternetGateway_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/internet-gateways/igw-123/attach", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DetachInternetGateway_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/internet-gateways/igw-123/detach", []byte(`{"VpcId":"vpc-123"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_DetachInternetGateway_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/internet-gateways/igw-123/detach", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_ListNatGateways_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "GET", "/vpc/nat-gateways", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateNatGateway_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/nat-gateways", []byte(`{"SubnetId":"subnet-123","AllocationId":"eipalloc-123"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateNatGateway_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/nat-gateways", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DeleteNatGateway_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/nat-gateways/nat-123", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_ListNetworkAcls_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "GET", "/vpc/network-acls", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateNetworkAcl_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/network-acls", []byte(`{"VpcId":"vpc-123"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateNetworkAcl_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/network-acls", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DeleteNetworkAcl_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/network-acls/acl-123", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateNetworkAclEntry_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/network-acls/acl-123/entries", []byte(`{"RuleNumber":100,"Protocol":"-1","RuleAction":"allow","CidrBlock":"0.0.0.0/0","Egress":false}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateNetworkAclEntry_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/network-acls/acl-123/entries", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_DeleteNetworkAclEntry_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/network-acls/acl-123/entries/100", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_ListFlowLogs_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "GET", "/vpc/flow-logs", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateFlowLogs_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/flow-logs", []byte(`{"ResourceIds":["vpc-123"],"ResourceType":"Vpc","TrafficType":"All","LogGroupName":"my-log-group"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_CreateFlowLogs_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/flow-logs", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
	assert.Equal(t, true, resp["Unsupported"])
...
func TestVpc_DeleteFlowLogs_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/flow-logs/fl-123", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_ListElasticIps_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "GET", "/vpc/elastic-ips", []byte(`{}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_AllocateElasticIp_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/elastic-ips", []byte(`{"Domain":"vpc"}`))
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_AllocateElasticIp_Error(t *testing.T) {
	...
	w := performVpcRequest(handler, "POST", "/vpc/elastic-ips", []byte(`{}`))
	assert.Equal(t, http.StatusInternalServerError, w.Code)
	var resp map[string]interface{}
	assert.NoError(t, json.Unmarshal(w.Body.Bytes(), &resp))
...
func TestVpc_ReleaseElasticIp_Success(t *testing.T) {
	...
	w := performVpcRequest(handler, "DELETE", "/vpc/elastic-ips/eipalloc-123", nil)
	assert.Equal(t, http.StatusOK, w.Code)
}
...
func TestVpc_ParseError(t *testing.T) {
	...
	routerActions := []struct {
		...
		{name: "ListVpcs", method: "GET", path: "/vpc/vpcs"},
		{name: "CreateVpc", method: "POST", path: "/vpc/vpcs"},
		{name: "ListSubnets", method: "GET", path: "/vpc/subnets"},
		{name: "CreateSubnet", method: "POST", path: "/vpc/subnets"},
		{name: "ListRouteTables", method: "GET", path: "/vpc/route-tables"},
		{name: "CreateRouteTable", method: "POST", path: "/vpc/route-tables"},
		{name: "CreateRoute", method: "POST", path: "/vpc/route-tables/rtb-123/routes"},
		{name: "AssociateRouteTable", method: "POST", path: "/vpc/route-tables/rtb-123/associate"},
		{name: "DisassociateRouteTable", method: "POST", path: "/vpc/route-tables/rtb-123/disassociate"},
		{name: "ListInternetGateways", method: "GET", path: "/vpc/internet-gateways"},
		{name: "CreateInternetGateway", method: "POST", path: "/vpc/internet-gateways"},
		{name: "AttachInternetGateway", method: "POST", path: "/vpc/internet-gateways/igw-123/attach"},
		{name: "DetachInternetGateway", method: "POST", path: "/vpc/internet-gateways/igw-123/detach"},
		{name: "ListNatGateways", method: "GET", path: "/vpc/nat-gateways"},
		{name: "CreateNatGateway", method: "POST", path: "/vpc/nat-gateways"},
		{name: "ListNetworkAcls", method: "GET", path: "/vpc/network-acls"},
		{name: "CreateNetworkAcl", method: "POST", path: "/vpc/network-acls"},
		{name: "CreateNetworkAclEntry", method: "POST", path: "/vpc/network-acls/acl-123/entries"},
		{name: "ListFlowLogs", method: "GET", path: "/vpc/flow-logs"},
		{name: "CreateFlowLogs", method: "POST", path: "/vpc/flow-logs"},
		{name: "ListElasticIps", method: "GET", path: "/vpc/elastic-ips"},
		{name: "AllocateElasticIp", method: "POST", path: "/vpc/elastic-ips"},
	}
	...
	for _, ra := range routerActions {
		...
		t.Run(ra.name, func(t *testing.T) {
			...
			w := performVpcRequest(handler, ra.method, ra.path, []byte(`{bad json`))
