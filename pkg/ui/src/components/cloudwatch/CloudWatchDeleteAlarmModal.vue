...
<template>
  ...
  >
    ...
    >
      ...
      >
        <h2 class="text-lg font-semibold" :class="settingsStore.darkMode ? 'text-dark-text' : 'text-light-text'">Delete Alarm</h2>
      ...
      <div class="px-6 py-4">
        <p class="text-sm" :class="settingsStore.darkMode ? 'text-dark-text' : 'text-light-text'">
          Are you sure you want to delete alarm <strong>{{ alarmName }}</strong>? This action cannot be undone.
        </p>
      </div>
      <div
