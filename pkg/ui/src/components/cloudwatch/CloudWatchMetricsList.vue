  ...
  <div class="space-y-4">
    ...
    >
      ...
      >
        ...
        <div class="col-span-4 text-sm text-light-muted dark:text-dark-muted">
          {{ metric.Namespace }}
        </div>
      ...
      >
        <div class="mt-4">
          ...
          <div
            v-if="metricStats[metric.MetricName + metric.Namespace]"
            class="mt-2"
          >
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr
                  v-for="(stat, i) in metricStats[metric.MetricName + metric.Namespace]"
                  :key="i"
                >
                  <td class="py-1">
