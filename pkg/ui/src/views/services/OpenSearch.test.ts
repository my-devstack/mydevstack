...
vi.mock('@/composables/useOpenSearch', () => ({
  useOpenSearch: () => ({
    ...
    expandedDomains: ref<Record<string, any>>({}),
    showCreateModal: ref(false),
    showDeleteConfirm: ref(false),
    domainToDelete: ref<any>(null),
    codeExamples: ref<Record<string, any>>({}),
    creating: ref(false),
    domainDetails: ref<Record<string, any>>({}),
    loadingDomainDetails: ref(false),
    compatibleVersions: ref<any[]>([]),
    ...
    getStatus: vi.fn(),
    createDomain: vi.fn(),
    createForm: ref<Record<string, any>>({}),
