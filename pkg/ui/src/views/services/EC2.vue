            ...
            >
              <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <p class="text-sm text-light-text dark:text-dark-text font-mono">{{ sg.GroupId }}</p>
                </div>
                <div>
                  <label class="block text-xs font-medium text-light-muted dark:text-dark-muted uppercase mb-1">Group Name</label>
                  <p class="text-sm text-light-text dark:text-dark-text">{{ sg.GroupName }}</p>
                </div>
                <div>
                  <label class="block text-xs font-medium text-light-muted dark:text-dark-muted uppercase mb-1">Description</label>
                  <p class="text-sm text-light-text dark:text-dark-text">{{ sg.Description }}</p>
                </div>
                <div>
                  <label class="block text-xs font-medium text-light-muted dark:text-dark-muted uppercase mb-1">VPC ID</label>
                  <p class="text-sm text-light-text dark:text-dark-text font-mono">{{ sg.VpcId }}</p>
                </div>
              </div>
                  ...
                  <table class="w-full text-sm border-collapse">
                    <thead>
                      <tr class="border-b border-light-border dark:border-dark-border">
                        <th class="text-left py-2 px-3 text-xs font-medium text-light-muted dark:text-dark-muted uppercase">Protocol</th>
                        <th class="text-left py-2 px-3 text-xs font-medium text-light-muted dark:text-dark-muted uppercase">Port Range</th>
                        <th class="text-left py-2 px-3 text-xs font-medium text-light-muted dark:text-dark-muted uppercase">Source</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr
                      ...
                      >
                        <td class="py-2 px-3 text-light-text dark:text-dark-text">{{ rule.IpProtocol }}</td>
              ...
              <div v-else>
                <label class="block text-xs font-medium text-light-muted dark:text-dark-muted uppercase mb-2">Ingress Rules</label>
                <p class="text-sm text-light-muted dark:text-dark-muted">No ingress rules</p>
              </div>
            </div>
          </div>
